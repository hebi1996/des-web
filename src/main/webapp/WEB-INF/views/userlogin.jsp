...
<html>
	<head>
		...
		<link href="static/loginUI/css/ionicons.css" rel="stylesheet" type="text/css" />
		<link href="static/loginUI/css/_all-skins.css" rel="stylesheet" type="text/css" />
		<link href="static/loginUI/css/castle.css" rel="stylesheet" type="text/css" />
		<link href="static/loginUI/css/castle-main.css" rel="stylesheet" type="text/css" />
		<link href="static/loginUI/css/fontsize.css" rel="stylesheet" type="text/css" />
		...
		<link href="static/loginUI/css/loginUI.css" rel="stylesheet" type="text/css">
		<!--  
		...
		<script type="text/javascript" src="static/loginUI/js/lufylegend-1.10.1.simple.min.js"></script>
		<script type="text/javascript" src="static/loginUI/js/lufylegend.LoadingSample4-0.1.0.min.js"></script>
		...
		<script type="text/javascript" src="chinasofti/userlogin/js/userlogin.js"></script>
					...
					<div id="message"style="position:absolute;color:red;margin-top:-20px;margin-left:100px;" > </div>
						...
						<div class="content" >
							<div class="navbar-header">
					           	<div>
									<span style="font-family:'Britannic Bold', 'Britannic';color:#3BC5BB;">JZ - 极宅 </span>
					        ...
					        <div >
					        	<button type="button" onclick="subLogin()" id="login-submit-btn" class="layui-btn  btn-login"  style="width:150px">&nbsp;&nbsp;登　录&nbsp;&nbsp;</button>
<%-- 					       	    <button type="button" title="<!-- 刷脸 -->登录" data-search-open="" data-title="刷脸登录" modal-toggle="modal" data-href="userFace" data-width="780" data-height="500" class="layui-btn  btn-login"  style="width:100px">&nbsp;&nbsp;刷    脸&nbsp;&nbsp;</button>
 --%>						    	<button type="button" title="用户注册" data-search-open="" data-title="用户注册" modal-toggle="modal" data-href="userRegister" data-width="780" data-height="500" class="layui-btn  btn-login"  style="width:150px">&nbsp;&nbsp;注    册&nbsp;&nbsp;</button>
						    </div> 
