										...
										<table id="example2" class="table table-bordered table-hover dataTable" role="grid">
											<thead>
												<tr role="row">
													...
													<th style="text-align:center;" class="sorting" rowspan="1" colspan="1">积分</th>
											...
											<tbody id="POST_LIST_TBODY_ID">
												<c:forEach items="${page.list }" var="u">
													<tr bgcolor="#FFFFFF">
														...
														<td valign="center" align="center" width="30">${u.integral }</td>
														<td valign="center" align="center" width="30">
															<a href="javascript:" onclick="users_edit(${u.id },'${u.loginName }','${u.loginPwd }','${u.trueName }','${u.email }','${u.phone }','${u.address }','${u.integral }')">编辑</a>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
