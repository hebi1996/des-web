	...
	<body style="height: auto;">
	    ...
	    <script type="text/javascript">
		    			...
		    			success:function(data){
		    				$.each(data, function(name, value) {
								$("#POST_LIST_TBODY_ID").append(
										"<tr bgcolor='#FFFFFF'>"+
											"<td  valign='center' align='center' width='30'>"+value.mealId+"</td>"+
											"<td  valign='center' align='center' width='30'>"+value.cuisine.seriesName+"</td>"+
											"<td  valign='center' align='center' width='30'>"+value.mealName+"</td>"+
											
											"<td  valign='center' align='center' width='30'>"+value.mealSummarize+"</td>"+
											"<td  valign='center' align='center' width='30'>"+value.mealPrice+"</td>"+
											"<td  valign='center' align='center' width='30'>"+
											"<a href='javascript:' onclick=\"meal_edit("+value.mealId+",'"+value.mealName+"',+"+value.mealSeriesId+",'"+value.mealSummarize+"','"+value.mealDescription+"',"+value.mealPrice+")\">编辑</a>"+
											"</td>"+
											"<td  valign='center' align='center' width='30'>"+
											"<a href='javascript:' onclick='meal_edit_img("+value.mealId+")'>上传</a>"+
											"</td>"+
											"<td  valign='center' align='center' width='30'>"+
											"<a href='javascript:' onclick='DELETE_MEAL("+value.mealId+")'>删除</a>"+
											"</td>"+
										"</tr>")
		    				});
		    			},
				...
				/* <tr bgcolor="#FFFFFF">		
													...
													<td valign="center" align="center" width="30">塌豆腐玲珑别致，整齐端庄。</td>
													<td valign="center" align="center" width="30">16</td>
													<td valign="center" align="center" width="30">
														<a href="" onclick="meal_edit('10'); return false;">编辑</a>
													</td>
													<td valign="center" align="center" width="30">
														<a href="" onclick="meal_edit_img('10'); return false;">上传</a>
													</td>
													<td valign="center" align="center" width="30">
														<a href="" onclick="DELETE_MEAL('10'); return false;">删除</a>
													</td>
												</tr> */
